...
for pageNumber in range(1,87):
    f = open('vodkaURL.txt', 'a')
    print("Working on Page " + str(pageNumber) + " !")
    if pageNumber == 1:
        page = scraper.get("https://drizly.com/liquor/vodka/c89")
    else:
        page = scraper.get("https://drizly.com/liquor/vodka/c89/" + "page" + str(pageNumber))
