...
for pageNumber in range(1,57):
    f = open('tequilaURL.txt', 'a')
    print("Working on Page " + str(pageNumber) + " !")
    if pageNumber == 1:
        page = scraper.get("https://drizly.com/liquor/tequila/c88")
    else:
        page = scraper.get("https://drizly.com/liquor/tequila/c88/" + "page" + str(pageNumber))
