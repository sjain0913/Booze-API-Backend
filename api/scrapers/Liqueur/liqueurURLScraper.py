...
for pageNumber in range(1,88):
    f = open('liqueurURL.txt', 'a')
    print("Working on Page " + str(pageNumber) + " !")
    if pageNumber == 1:
        page = scraper.get("https://drizly.com/liquor/liqueur/c196877")
    else:
        page = scraper.get("https://drizly.com/liquor/liqueur/c196877/" + "page" + str(pageNumber))
